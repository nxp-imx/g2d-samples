...
define PINFO
PINFO DESCRIPTION="g2d overlay test"
endef

NAME=g2d_overlay_test
...
EXTRA_INCVPATH += $(test_source_root)/overlay_test

EXTRA_SRCVPATH += $(test_source_root)/overlay_test
EXTRA_SRCVPATH += $(test_source_root)/overlay_test/os/qnx

SOURCE_OBJECTS += $(test_source_root)/overlay_test/os/qnx/gfx_init.o
SOURCE_OBJECTS += $(test_source_root)/overlay_test/g2d_overlay_test.o
